...
namespace Game.Avatar.SpiderImpl.Raycasting {
    ...
    sealed class PositionRelative {
        ...
        public void setParent(Transform m_parent) {
            var old_Position = getWorldPosition();
            parent = m_parent;
    ...
    abstract class Cast {
        ...
        public void setDistance(float m_distance) { var p = getOrigin(); end.setWorldPosition(p + (getEnd() - p).normalized * m_distance); }
